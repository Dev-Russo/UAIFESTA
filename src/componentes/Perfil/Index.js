...
import tommorow from '../imgs/169073370264c68c86a8724_1690733702_3x2_xl.jpg';
                                    ...
                                    <Col>
                                        <Card style={{ width: '30rem' }}>
                                            <Card.Body style={{}}>
                                                ...
                                                <Card.Text>
                                                    <Card.Body>TomorrowLand</Card.Body>
                                                        ...
                                                        <div class="d-flex py-2">
                                                            <div class="second py-2 px-2"> <span class="text1">Muito bom os produtos oferecidos</span>
                                                                <div class="d-flex justify-content-between py-1 pt-2">
                                                                    <div><img src={tommorow} width="18" height="18" /><span class="text2">Martha</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex  py-2">
                                                            <div class="second py-2 px-2"> <span class="text1">Melhor tenda da minha vida</span>
                                                                <div class="d-flex justify-content-between py-1 pt-2">
                                                                    <div><img src={tommorow} width="18" /><span class="text2">Curtis</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex py-2">
                                                            <div class="second py-2 px-2"> <span class="text1">Melhor palco que já tive a experiencia de usa</span>
                                                                <div class="d-flex justify-content-between py-1 pt-2">
                                                                    <div><img src={tommorow} width="18" height="18" /><span class="text2">Beth</span></div>
                                                                </div>
                                                            </div>
                                                        </div>
